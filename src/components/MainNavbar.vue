    ...
    >
      ...
      <div class="flex items-center gap-4">
        ...
        <form class="mb-0 hidden lg:flex">
          <div class="relative">
            <input
              class="h-10 rounded-lg border-gray-200 pr-5 text-sm placeholder-gray-400 border px-5 focus:z-10"
              placeholder="Search..."
              type="text"
            />
      ...
      >
        <a class="text-gray-900" href="">Items</a>
        <a class="text-gray-900" href="">Equipment Rental</a>
        <a class="text-gray-900" href="">Dive Package</a>
      </nav>
